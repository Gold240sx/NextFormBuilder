...
const PreviewDialogButton = () => {
	...
	return (
		<Dialog>
			...
			<DialogContent className="bg-gradient-to-r from-indigo-500 to-sky-500 h-full w-screenl max-h-screen mt-16 p-0.5  shadow-2xl dark:shadow-teal-400/40 [backdrop-filter: blur(2px)]">
				<div className=" w-full max-w-full flex flex-col flex-grow p-0 gap-0 overflow-y-scroll bg-background rounded-md pt-[.4rem] pb-4 relative">
					...
					<div className="bg-black/80 flex flex-col flex-grow items-center justify-center p-4 overflow-y-scroll">
						<div className="max-w-[620px] flex flex-col gap-4 flex-grow bg-background/90 h-full w-full rounded-lg p-8 overflow-y-scroll z-10">
